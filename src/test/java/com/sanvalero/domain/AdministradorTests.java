...
public class AdministradorTests {
    ...
    public void registrarVendedorTest() {
        ...
        Vendedor vendedor = new Vendedor(0, "a", "b", "c", "d", "e", 0, 0);
        Assertions.assertEquals(vendedor, administrador.registrarVendedor(0, "a", "b", "c", "d", "e", 0));

        Vendedor vendedor1 = new Vendedor(0, "4", "4", "4", "4", "4", 0, 0);
    ...
    public void resgistrarCoche() {
        ...
        Coche coche1 = new Coche("1", "1", "1", "1", "1", 0, 0, true, 0, 0);
    ...
    public void resgistrarMoto() {
        ...
        Moto moto1 = new Moto("1", "1", "1", "1", "1", 0, 0, true);
